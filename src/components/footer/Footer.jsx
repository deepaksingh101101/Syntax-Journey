                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-xl-6">
                        <form className="d-flex flex-row mb-2 p-1 bg-white input-group">
                            ...
                            <button className="btn btn-danger rounded-0 flex-shrink-0" type="submit">Subscribe</button>
                        </form>
                    </div>
                    <div className="col-lg-4 col-xl-3">
...
<i className="fab fa-linkedin-in"></i>
                ...
                <div className="col-sm-6 col-lg-2 my-4">
                    <h5 className="mainColor fw-semibold h6 mb-4">Customer</h5>
                ...
                <div className="col-sm-6 col-lg-2 my-4">
                    <h5 className="mainColor fw-semibold h6 mb-4">Product</h5>
                    <ul className="list-unstyled white-link footer-links">
                        <li>
                            <a href="#">Portfolio</a>
                        </li>
                ...
                <div className="col-sm-6 col-lg-2 my-4">
                    <h5 className="mainColor fw-semibold h6 mb-4">Company</h5>
                    <ul className="list-unstyled white-link footer-links">
                        <li>
                            <a href="#">About</a>
                        </li>
                    ...
                    <div className="white-link">
                        <div className="d-flex pb-3">
                            ...
                            <div className="col ps-3">
                                <small className="mainColor fw-semibold">29 March 2021</small>
                        ...
                        <div className="d-flex">
                            ...
                            <div className="col ps-3">
                                <small className="mainColor fw-semibold">14 June 2024</small>
                                <h6 className="font-w-500 h6 m-0"><a className="text-white" href="#">Markdown Language Sample Blog Post Styling</a></h6>
                            </div>
                        </div>
                    </div>
