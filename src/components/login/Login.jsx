        ...
        <div className="col-md-6 contents">
          <div className="row justify-content-center">
            ...
            <form action="#" method="post">
              ...
              <input type="submit" value="Log In" style={{background:"#0B8AB6",color:"white"}} className="btn btn-block  w-100 "/>

<div className="d-flex justify-content-between">

              <span className="d-block text-left my-4 text-muted">&mdash; or login with &mdash;</span>
              <span className="d-block text-left my-4 text-muted">&mdash; or <Link to='/register' className='fw-semibold' style={{textDecoration:"none", color:"#0B8AB6"}}>New Here &mdash;</Link></span>
</div>
